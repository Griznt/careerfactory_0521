        ...
        for row in csv_dict_reader:
            ...
            if userSessions:
                ...
                for session in userSessions:
                    ...
                    if not ONE_SESSION_LENGTH or timedelta < datetime.timedelta(hours=ONE_SESSION_LENGTH):
...
controlGroupUsersOnOrderCompleted = getNextFunnelStepResult('Order Completed.csv', controlGroupUsersOnProductAddedStep, 'orderCompleted', False)
controlGroupUsersOnProductAddedStep.clear()
controlGroupUsersOnOrderCompleted.clear()
...
testGroupUsersOnAddressChangeInitiatedStep = getNextFunnelStepResult('Address Change Initiated.csv', testGroupUniuqueUsers, 'addressChangeInitiated')
...
# testGroupUsersOnShopSelectedStep = getNextFunnelStepResult('Shop Selected.csv', testGroupUniuqueUsers, 'shopSelected')
# saveToFile('testGroupUsersOnShopSelectedStep.json', testGroupUsersOnShopSelectedStep)
...
testGroupUsersOnProductAddedStep = getNextFunnelStepResult('Product Added.csv', testGroupUniuqueUsers, 'productAdded', False)
# np.savetxt('/result/data.csv', (testGroupUsersOnProductAddedStep), delimiter=',')
saveToFile('testGroupUsersOnProductAddedStep.json', testGroupUsersOnProductAddedStep)
# testGroupUsersOnShopSelectedStep.clear()

#------------------
# product added step
testGroupUsersOnOrderCompleted = getNextFunnelStepResult('Order Completed.csv', testGroupUsersOnProductAddedStep, 'orderCompleted', False)
saveToFile('testGroupUsersOnOrderCompleted.json', testGroupUsersOnOrderCompleted)
testGroupUsersOnProductAddedStep.clear()
testGroupUsersOnOrderCompleted.clear()